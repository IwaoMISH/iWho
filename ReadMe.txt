========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : iWho
========================================================================


AppWizard が生成した iWho には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには iWho を構成している各ファイルの概要説明が含まれています。
...
iWho.h
    ...
    みます） をインクルードし、また CIWhoApp アプリケーションクラスを宣
    言します。

iWho.cpp
    このファイルは CIWhoApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\iWho.ico
    ...
    ルです。このアイコンはリソース ファイル iWho.rc によってインクルード
    されます。
...
iWhoDlg.h, iWhoDlg.cpp - ダイアログ
    これらのファイルは CIWhoDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な iWho.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) iWho.pch 
